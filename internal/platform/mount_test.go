...
func TestMountValidatePropagationFlag(t *testing.T) {
	scenarios := map[string]struct {
		...
		"MS_SHARED|MS_REC is valid":     {flag: unix.MS_SHARED | unix.MS_REC, valid: true},
		"MS_PRIVATE|MS_REC is valid":    {flag: unix.MS_PRIVATE | unix.MS_REC, valid: true},
		"MS_SLAVE|MS_REC is valid":      {flag: unix.MS_SLAVE | unix.MS_REC, valid: true},
		"MS_UNBINDABLE|MS_REC is valid": {flag: unix.MS_UNBINDABLE | unix.MS_REC, valid: true},
		"MS_BIND is invalid":            {flag: unix.MS_BIND, valid: false},
		"MS_RDONLY is invalid":          {flag: unix.MS_RDONLY, valid: false},
	}
